...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ \"./node_modules/@babel/runtime/helpers/toConsumableArray.js\");\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _modules_glide__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/glide */ \"./src/modules/glide.js\");\n/* harmony import */ var _modules_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/api-service */ \"./src/modules/api-service.js\");\n/* harmony import */ var _modules_prepare_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/prepare-data */ \"./src/modules/prepare-data.js\");\n/* harmony import */ var _modules_activate_template__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/activate-template */ \"./src/modules/activate-template.js\");\n/* harmony import */ var _modules_get_random_card__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/get-random-card */ \"./src/modules/get-random-card.js\");\n\n\n\n\n\n\nvar slider = document.querySelector('.slider');\nvar sliderWrapper = slider.querySelector('.glide__slides');\n\nfunction updateCards() {\n  _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(sliderWrapper.children).forEach(function (child) {\n    return child.remove();\n  });\n}\n\nvar loader = document.querySelector('.loader');\n\nfunction toggleLoader() {\n  loader.classList.toggle('loader--hidden');\n  slider.classList.toggle('slider--hidden');\n}\n\nfunction renderCards(value) {\n  var api = new _modules_api_service__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n  api.getResource(value).then(function (data) {\n    var container = new DocumentFragment();\n    var response = api.getId(data);\n    response.then(function (res) {\n      res.map(function (el) {\n        return container.append(Object(_modules_activate_template__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(Object(_modules_prepare_data__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(el)));\n      });\n      sliderWrapper.append(container);\n    }).then(function () {\n      setTimeout(function () {\n        toggleLoader();\n        var SLIDER = new _modules_glide__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n        SLIDER.init();\n      }, 500);\n    });\n  });\n}\n/* Render first cards */\n\n\nrenderCards(Object(_modules_get_random_card__WEBPACK_IMPORTED_MODULE_5__[\"default\"])());\n/* Form */\n\nvar searchForm = document.querySelector('.search-form');\nvar formField = searchForm.querySelector('.search-form__field');\nsearchForm.addEventListener('submit', function (evt) {\n  evt.preventDefault();\n  var value = formField.value;\n  value.replace(/[^A-Za-z0-9]/gi, '');\n  toggleLoader();\n  updateCards();\n  setTimeout(function () {\n    renderCards(value);\n    searchForm.reset();\n  }, 500);\n});\n\n//# sourceURL=webpack:///./src/index.js?");

/***/ }),

/***/ "./src/modules/activate-template.js":
/*!******************************************!*\
  !*** ./src/modules/activate-template.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return activateTemplate; });\nfunction activateTemplate(template) {\n  var cloneTemplate = template.content.querySelector('.glide__slide').cloneNode(true);\n  return cloneTemplate;\n}\n\n//# sourceURL=webpack:///./src/modules/activate-template.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ApiService; });\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ \"./node_modules/@babel/runtime/helpers/toConsumableArray.js\");\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/classCallCheck.js\");\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/createClass.js\");\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\n\nvar ApiService = /*#__PURE__*/function () {\n  function ApiService() {\n    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, ApiService);\n\n    this._apiBase = 'https://www.omdbapi.com/?&apikey=4b99ca0c&plot=full&s=';\n    this._dataHolder = null;\n  }\n\n  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(ApiService, [{\n    key: \"getResource\",\n    value: function () {\n      var _getResource = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(url) {\n        var res, answer;\n        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.next = 2;\n                return fetch(\"\".concat(this._apiBase).concat(url));\n\n              case 2:\n                res = _context.sent;\n\n                if (res.ok) {\n                  _context.next = 5;\n                  break;\n                }\n\n                throw new Error(\"Could not fetch \".concat(url, \", received \").concat(res.status));\n\n              case 5:\n                _context.next = 7;\n                return res.json();\n\n              case 7:\n                answer = _context.sent;\n                return _context.abrupt(\"return\", answer);\n\n              case 9:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function getResource(_x) {\n        return _getResource.apply(this, arguments);\n      }\n\n      return getResource;\n    }()\n  }, {\n    key: \"getId\",\n    value: function getId(data) {\n      var _this = this;\n\n      this._dataHolder = Object.assign({}, data);\n\n      if (this._dataHolder.Search) {\n        var currentData = this._dataHolder.Search;\n\n        var id = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(currentData).map(function (el) {\n          return el.imdbID;\n        });\n\n        var urls = id.map(function (i) {\n          return \"\".concat(_this._apiBase, \"&i=\").concat(i);\n        });\n        var requests = urls.map(function (url) {\n          return fetch(url);\n        });\n        return Promise.all(requests).then(function (responses) {\n          return responses;\n        }).then(function (responses) {\n          return Promise.all(responses.map(function (answer) {\n            return answer.json();\n          }));\n        }).then(function (info) {\n          return info.map(function (full) {\n            var Title = full.Title,\n                Poster = full.Poster,\n                Year = full.Year,\n                imdbRating = full.imdbRating;\n            return _this._dataHolder.result = {\n              Title: Title,\n              Poster: Poster,\n              Year: Year,\n              imdbRating: imdbRating\n            };\n          });\n        });\n      }\n\n      document.body.classList.add('load-error');\n      setTimeout(function () {\n        return window.location.reload();\n      }, 500);\n    }\n  }]);\n\n  return ApiService;\n}();\n\n\n\n//# sourceURL=webpack:///./src/modules/api-service.js?");

/***/ }),

/***/ "./src/modules/get-random-card.js":
/*!****************************************!*\
  !*** ./src/modules/get-random-card.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return getRandomCard; });\nfunction getRandomCard() {\n  var words = 'tribe, adoption, corpse, biology, authorise, store, soft, continuous, month, deny, color-blind, voucher, forget, bracket, tear, flexible, family, percent, vat, chocolate, presence, stretch, pen, patient, open, miner, forge, mushroom, real, finance, country, snow, correction, ring, drop, abundant, definition, timetable, assessment, invite, popular, software, foreigner, road, glimpse, elephant, friendly, aloof, make, volcano';\n  var wordsList = words.split(' ');\n  var randomWord = Math.floor(Math.random() * wordsList.length);\n  return wordsList[randomWord];\n}\n\n//# sourceURL=webpack:///./src/modules/get-random-card.js?");

/***/ }),

/***/ "./src/modules/glide.js":
/*!******************************!*\
  !*** ./src/modules/glide.js ***!
  \******************************/
/*! exports provided: default */
